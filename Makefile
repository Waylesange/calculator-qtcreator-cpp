...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ?? ????. 10 09:59:57 2012
# Project:  Calculator.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile Calculator.pro
#############################################################################
...
Makefile: Calculator.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile Calculator.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Calculator1.0.0/ && $(COPY_FILE) --parents widget.h .tmp/Calculator1.0.0/ && $(COPY_FILE) --parents main.cpp widget.cpp .tmp/Calculator1.0.0/ && (cd `dirname .tmp/Calculator1.0.0` && $(TAR) Calculator1.0.0.tar Calculator1.0.0 && $(COMPRESS) Calculator1.0.0.tar) && $(MOVE) `dirname .tmp/Calculator1.0.0`/Calculator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Calculator1.0.0
